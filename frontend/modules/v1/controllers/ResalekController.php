...
class ResalekController extends RestController {
	...
	/**
	 * 
	 * @OA\Get(path="/v1/resalek",
	 *     tags={"Вторичка (resale)"},
	 *     summary="Список коттеджей",
	...
	/**
	 * @OA\Post(path="/v1/resalek/create",
	 * 		tags={"Вторичка (resale)"},
	 * 		summary="Добавление коттеджа",
	 *     @OA\RequestBody(
	 *         @OA\MediaType(
	...
	/**
	 * @OA\Put(path="/v1/resalek/update/{id}",
	 * 		tags={"Вторичка (resale)"},
	 * 		summary="Изменение коттеджа",
	...
	/**
	 * @OA\Delete(path="/v1/resalek/delete/{id}",
	 * 		tags={"Вторичка (resale)"},
	 * 		summary="Удаление коттеджа",
	 * 		@OA\Parameter(name="id", in="path", description="Идентификатор", required=true),
	 * 		@OA\Response(
	 * 			response = 200,
	...
	/**
	 *
	 * @OA\Get(path="/v1/resalek/view/{id}",
	 *     tags={"Вторичка (resale)"},
	 *     summary="Просмотр коттеджа по id",
